      ...
      quizId = randomAlphaNumeric(16);
        ...
        FirebaseFirestore.instance
          ...
          setState(() {
            ...
            _isLoding=false;
            Navigator.pushReplacement(context, MaterialPageRoute(builder:(context)=>quizcreator(quizId)));
          });
        });
              ...
              InkWell(
                onTap: (){
                  ...
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) =>quizcreator(_subjectController.text)));
                },
                child: Container(
                  height: 106,
                  width: 106,
